      ...
      <section className="grid h-full grid-rows-[auto,1fr]">
        ...
        <div className="relative grid h-full items-center justify-center bg-hero-bg bg-cover bg-no-repeat">
          ...
          <div className="z-50 flex flex-col items-center justify-center gap-2 text-center">
            ...
            <h3 className="text-lg laptop:text-2xl font-light tracking-wider text-white">
              CITY OF DASMARINAS
            </h3>

            {/* sign up */}
            <div className="mt-8 grid w-full grid-flow-row items-center laptop:grid-cols-[1fr,auto]">
              <div className="rounded-tl-md rounded-tr-md bg-white py-6 px-12 laptop:rounded-bl-md laptop:rounded-tr-none">
                <span className="cursor-pointer text-center text-[#838383]">
                  Dont have an account yet?
                </span>
              </div>

              <button className="flex h-full items-center justify-center gap-5 rounded-br-md rounded-bl-md bg-green py-6 px-14 text-center text-white laptop:justify-start laptop:rounded-tr-md laptop:rounded-bl-none laptop:py-0 laptop:text-start">
